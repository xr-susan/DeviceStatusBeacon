...
public partial class InitialCreate : Migration {
	...
	protected override void Up(MigrationBuilder migrationBuilder) {
		...
		migrationBuilder.CreateTable(
			...
			columns: table => new {
				...
				LatestReportedAddresses = table.Column<string>(type: "TEXT", nullable: true),
		...
		migrationBuilder.CreateTable(
			name: "DeviceUser",
			columns: table => new {
				AuthorizedDevicesDeviceId = table.Column<Guid>(type: "TEXT", nullable: false),
				AuthorizedUsersId = table.Column<Guid>(type: "TEXT", nullable: false)
			},
			constraints: table => {
				table.PrimaryKey("PK_DeviceUser", x => new { x.AuthorizedDevicesDeviceId, x.AuthorizedUsersId });
				table.ForeignKey(
					name: "FK_DeviceUser_AspNetUsers_AuthorizedUsersId",
					column: x => x.AuthorizedUsersId,
					principalTable: "AspNetUsers",
					principalColumn: "Id",
					onDelete: ReferentialAction.Cascade);
				table.ForeignKey(
					name: "FK_DeviceUser_Devices_AuthorizedDevicesDeviceId",
					column: x => x.AuthorizedDevicesDeviceId,
		...
		migrationBuilder.CreateTable(
			name: "ApiCredentialDevice",
			columns: table => new {
				AuthorizedApiCredentialsApiCredentialId = table.Column<Guid>(type: "TEXT", nullable: false),
				AuthorizedDevicesDeviceId = table.Column<Guid>(type: "TEXT", nullable: false)
			},
			constraints: table => {
				table.PrimaryKey("PK_ApiCredentialDevice", x => new { x.AuthorizedApiCredentialsApiCredentialId, x.AuthorizedDevicesDeviceId });
				table.ForeignKey(
					name: "FK_ApiCredentialDevice_ApiCredentials_AuthorizedApiCredentialsApiCredentialId",
					column: x => x.AuthorizedApiCredentialsApiCredentialId,
					principalTable: "ApiCredentials",
					principalColumn: "ApiCredentialId",
					onDelete: ReferentialAction.Cascade);
				table.ForeignKey(
					name: "FK_ApiCredentialDevice_Devices_AuthorizedDevicesDeviceId",
					column: x => x.AuthorizedDevicesDeviceId,
					principalTable: "Devices",
					principalColumn: "DeviceId",
					onDelete: ReferentialAction.Cascade);
		...
		migrationBuilder.InsertData(
			...
			values: new object[] { "EntityAuthInfoVersion", "0" });

		migrationBuilder.CreateIndex(
			name: "IX_ApiCredentialDevice_AuthorizedDevicesDeviceId",
			table: "ApiCredentialDevice",
			column: "AuthorizedDevicesDeviceId");

		migrationBuilder.CreateIndex(
			name: "IX_ApiCredentials_UserId_DisplayName",
		...
		migrationBuilder.CreateIndex(
			name: "IX_DeviceUser_AuthorizedUsersId",
			table: "DeviceUser",
		...
		migrationBuilder.CreateIndex(
			name: "IX_OnlineLogs_DeviceId_OnlineLogId",
			table: "OnlineLogs",
			columns: new[] { "DeviceId", "OnlineLogId" });
	...
	protected override void Down(MigrationBuilder migrationBuilder) {
		migrationBuilder.DropManagedSqliteTriggers();
