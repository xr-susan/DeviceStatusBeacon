...
public static partial class ConsoleDispatcher {
	...
	private static async Task<int> HandleApiCredentialListAsync(IServiceProvider sp) {
	...
	/// </summary>
	/// <param name="sp">负责依赖注入的服务提供者</param>
	/// <param name="ownerUserNameToQuery">要查询的所属用户名</param>
	/// <returns>一个表示异步操作的任务，返回操作结果的状态码</returns>
	private static async Task<int> HandleApiCredentialQueryByUserAsync(IServiceProvider sp, string ownerUserNameToQuery) {
		await using var db = sp.GetRequiredService<DeviceStatusBeaconContext>();
	...
	/// <summary>
	/// 处理 api-credential add <owner-user-name> <role> 命令
	/// </summary>
	/// <param name="sp">负责依赖注入的服务提供者</param>
	/// <param name="ownerUserNameToAdd">所属用户名</param>
	/// <param name="roleString">要分配的角色字符串</param>
	/// <returns>一个表示异步操作的任务，返回操作结果的状态码</returns>
	private static async Task<int> HandleApiCredentialAddAsync(IServiceProvider sp, string ownerUserNameToAdd, string roleString) {
	...
	/// </summary>
	/// <param name="sp">负责依赖注入的服务提供者</param>
	/// <param name="credentialIdStringToReset">要重置的 API 凭据 ID 字符串</param>
	/// <returns>一个表示异步操作的任务，返回操作结果的状态码</returns>
	private static async Task<int> HandleApiCredentialResetKeyAsync(IServiceProvider sp, string credentialIdStringToReset) {
	...
	/// </summary>
	/// <param name="sp">负责依赖注入的服务提供者</param>
	/// <param name="credentialIdStringToDelete">要删除的 API 凭据 ID 字符串</param>
	/// <returns>一个表示异步操作的任务，返回操作结果的状态码</returns>
	private static async Task<int> HandleApiCredentialDeleteAsync(IServiceProvider sp, string credentialIdStringToDelete) {
